...
$(document).ready(function(){$(".site-header").parallax({imageSrc:"img/top_bg.jpg"}),$(".portfolio-item").magnificPopup({delegate:"a",gallery:{enabled:!0},type:"image"}),$(".portfolio-wrap").mixItUp(),$(".s-portfolio li").click(function(){$(".s-portfolio li").removeClass("active"),$(this).addClass("active")}),$("#my-menu").mmenu({extensions:["theme-black","effect-menu-slide","pagedim-black"],navbar:{title:'<img src="img/logo.svg" alt="Valeria Tsylibina">'},offCanvas:{position:"right"}}),$(".header-composition a").mPageScroll2id();var e=$("#my-menu").data("mmenu");e.bind("open:finish",function(){$(".hamburger").addClass("is-active")}),e.bind("close:finish",function(){$(".hamburger").removeClass("is-active")}),$("select").selectize(),$(".reviews").owlCarousel({loop:!0,items:1,smartSpeed:700,autoHeight:!0}),$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(".top").addClass("active"):$(".top").removeClass("active")}),$(".top").click(function(){$("html, body").stop().animate({scrollTop:0},"slow","swing")}),$("form.callback").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"/mail.php",data:e.serialize()}).done(function(){$(e).find(".success").addClass("active").css("display","flex").hide().fadeIn(),setTimeout(function(){$(e).find(".success").removeClass("active").fadeOut(),e.trigger("reset")},3e3)}),!1}),$("section .h2").each(function(){var e=$(this);e.html(e.html().replace(/^(\S+)/,"<span>$1</span>"))}),$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow")}),$("h1").animated("fadeInDown","fadeOutUp"),$(".header-composition p").animated("fadeInUp","fadeOutDown")}),$(window).on("load",function(){$(".loader").delay(1e3).fadeOut("slow")});